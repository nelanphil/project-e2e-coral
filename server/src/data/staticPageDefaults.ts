/**
 * Default sections for static pages. Used to seed the DB when a page has no content.
 * Keep in sync with client/src/lib/page-sections.ts PAGE_DEFINITIONS.
 */
export type DefaultSection = { key: string; label: string; content: string };

const DEFAULT_PAGE_SECTIONS: Record<string, DefaultSection[]> = {
  "customer-service": [
    {
      key: "intro",
      label: "About Our Support",
      content: `<p>At Coral Store, we're passionate about helping you succeed with your reef aquarium. Our customer service team consists of experienced reef hobbyists who understand the unique needs of coral enthusiasts. Whether you have a question about a specific coral species, need help with acclimation, or have a concern about your order, we're here to help.</p>
<p>We pride ourselves on fast, knowledgeable responses and stand behind every coral we ship. Your satisfaction — and the health of your reef — is our top priority.</p>`,
    },
    {
      ...
      content: `<h3>How do I acclimate new corals?</h3>
...
<p>Yes, you can request a specific ship date during checkout or by contacting us. We'll do our best to accommodate your preferred delivery window.</p>`,
    },
    {
      ...
      content: `<p>Our support team is available Monday–Friday, 9 AM – 5 PM EST.</p>
<ul>
  ...
  "shipping-returns": [
    {
      ...
      content: `<p>We ship live corals and livestock Monday through Wednesday only, to ensure packages never sit in transit over a weekend. All orders are shipped via FedEx Overnight or Priority Overnight to minimize transit time and stress on the animals.</p>
...
<p>We carefully pack all orders with insulated boxes, heat packs (in winter), and cold packs (in summer) to maintain safe temperatures throughout transit.</p>`,
    },
    {
      ...
      content: `<h3>Florida Residents</h3>
...
<ul>
  ...
  <li>Someone must be available to receive the package on the delivery day.</li>
    ...
    },
    {
      ...
      content: `<p>Due to the living nature of our products, we are unable to accept returns on livestock (corals, fish, or invertebrates). All sales are final once livestock has shipped.</p>
...
<p>If you received an incorrect item, please contact us within 48 hours of delivery and we will resolve the issue at no cost to you.</p>`,
    },
    {
      ...
      content: `<p>We guarantee that all livestock will arrive alive and healthy. If any animal arrives dead or severely stressed, please follow these steps:</p>
<ul>
  ...
  "privacy-policy": [
    {
      key: "overview",
      label: "Overview",
      content: `<p>Last updated: March 2025</p>
<p>Coral Store ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and share information about you when you use our website and services. By using our site, you agree to the practices described in this policy.</p>`,
    },
    {
      ...
      content: `<p>We collect information you provide directly to us, such as:</p>
<ul>
...
<ul>
  ...
  <li>Comply with legal obligations.</li>
    ...
    },
    {
      ...
      content: `<p>We use cookies and similar tracking technologies to enhance your experience on our site. Cookies help us remember your preferences, keep your cart intact between sessions, and understand how visitors use our site.</p>
<p>You can control cookies through your browser settings. Please note that disabling certain cookies may affect the functionality of our website (for example, your shopping cart may not function correctly).</p>`,
    },
    {
      ...
      content: `<p>We share information with trusted third parties only as necessary to operate our business:</p>
<ul>
...
<p>We do not sell your personal information to third parties.</p>`,
    },
    {
      key: "contact",
      label: "Contact Us",
      content: `<p>If you have any questions or concerns about this Privacy Policy or your personal data, please contact us:</p>
<ul>
...
<p>By accessing or using the Coral Store website (the "Site") or placing an order with us, you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Site. We reserve the right to update these Terms at any time, and continued use of the Site after changes constitutes acceptance of the updated Terms.</p>`,
    },
    {
      key: "accounts",
      label: "User Accounts",
      content: `<p>When you create an account on our Site, you are responsible for maintaining the confidentiality of your login credentials and for all activities that occur under your account. You agree to:</p>
<ul>
...
<p>We reserve the right to suspend or terminate accounts that violate these Terms or that we believe are being used fraudulently.</p>`,
    },
    {
      ...
      content: `<p>All prices on our Site are listed in US dollars and are subject to change without notice. By placing an order, you authorize us to charge your payment method for the total order amount including any applicable taxes and shipping fees.</p>
...
<p>All sales on livestock are final once the order has shipped. Please see our Shipping &amp; Returns page for our Live Arrival Guarantee policy.</p>`,
    },
    {
      ...
      content: `<p>By purchasing live corals, fish, or invertebrates from Coral Store, you acknowledge and agree to the following:</p>
<ul>
...
<p>We are not responsible for livestock losses that occur after successful delivery and acclimation due to unsuitable water parameters, incompatible tankmates, or other environmental factors outside our control.</p>`,
    },
    {
      ...
      content: `<p>To the maximum extent permitted by applicable law, Coral Store shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Site or purchase of our products, even if we have been advised of the possibility of such damages.</p>
<p>Our total liability for any claim arising from or related to our products or services shall not exceed the amount you paid for the specific product or service giving rise to the claim.</p>`,
    },
    {
      ...
      content: `<p>We reserve the right to modify these Terms of Service at any time. We will notify users of significant changes by posting a notice on our Site or by sending an email to registered account holders. The updated Terms will be effective upon posting, and your continued use of the Site after that date constitutes acceptance of the revised Terms.</p>
<p>If you have any questions about these Terms, please contact us at legal@coralstore.com.</p>`,
    },
  ],
};

export function getDefaultSections(slug: string): { key: string; label: string; content: string; hidden: boolean }[] | null {
  const sections = DEFAULT_PAGE_SECTIONS[slug];
  if (!sections) return null;
  return sections.map((s) => ({ ...s, hidden: false }));
}

export function getDefaultSlugs(): string[] {
