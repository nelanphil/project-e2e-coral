...
/** @internal */
export declare const ObjectState$inboundSchema: z.ZodMiniEnum<typeof ObjectState>;
/** @internal */
export declare const ObjectState$outboundSchema: z.ZodMiniEnum<typeof ObjectState>;
/** @internal */
export declare const Parcel$inboundSchema: z.ZodMiniType<Parcel, unknown>;
/** @internal */
...
/** @internal */
export declare const Parcel$outboundSchema: z.ZodMiniType<Parcel$Outbound, Parcel>;
