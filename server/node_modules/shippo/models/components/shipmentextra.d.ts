...
/** @internal */
export declare const AncillaryEndorsement$inboundSchema: z.ZodMiniEnum<typeof AncillaryEndorsement>;
/** @internal */
export declare const AncillaryEndorsement$outboundSchema: z.ZodMiniEnum<typeof AncillaryEndorsement>;
/** @internal */
export declare const DangerousGoodsCode$inboundSchema: z.ZodMiniEnum<typeof DangerousGoodsCode>;
/** @internal */
export declare const DangerousGoodsCode$outboundSchema: z.ZodMiniEnum<typeof DangerousGoodsCode>;
/** @internal */
export declare const PreferredDeliveryTimeframe$inboundSchema: z.ZodMiniEnum<typeof PreferredDeliveryTimeframe>;
/** @internal */
export declare const PreferredDeliveryTimeframe$outboundSchema: z.ZodMiniEnum<typeof PreferredDeliveryTimeframe>;
/** @internal */
export declare const ReturnServiceType$inboundSchema: z.ZodMiniType<ReturnServiceType, unknown>;
/** @internal */
export type ReturnServiceType$Outbound = string | string;
/** @internal */
export declare const ReturnServiceType$outboundSchema: z.ZodMiniType<ReturnServiceType$Outbound, ReturnServiceType>;
export declare function returnServiceTypeToJSON(returnServiceType: ReturnServiceType): string;
export declare function returnServiceTypeFromJSON(jsonString: string): SafeParseResult<ReturnServiceType, SDKValidationError>;
/** @internal */
export declare const SignatureConfirmation$inboundSchema: z.ZodMiniEnum<typeof SignatureConfirmation>;
/** @internal */
export declare const SignatureConfirmation$outboundSchema: z.ZodMiniEnum<typeof SignatureConfirmation>;
/** @internal */
export declare const ShipmentExtra$inboundSchema: z.ZodMiniType<ShipmentExtra, unknown>;
/** @internal */
...
/** @internal */
export declare const ShipmentExtra$outboundSchema: z.ZodMiniType<ShipmentExtra$Outbound, ShipmentExtra>;
export declare function shipmentExtraToJSON(shipmentExtra: ShipmentExtra): string;
export declare function shipmentExtraFromJSON(jsonString: string): SafeParseResult<ShipmentExtra, SDKValidationError>;
