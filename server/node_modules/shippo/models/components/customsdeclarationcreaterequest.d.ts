...
/** @internal */
export declare const CustomsDeclarationCreateRequestType$outboundSchema: z.ZodMiniEnum<typeof CustomsDeclarationCreateRequestType>;
/** @internal */
...
/** @internal */
export declare const CustomsDeclarationCreateRequestAddress$outboundSchema: z.ZodMiniType<CustomsDeclarationCreateRequestAddress$Outbound, CustomsDeclarationCreateRequestAddress>;
...
/** @internal */
export declare const DutiesPayor$outboundSchema: z.ZodMiniType<DutiesPayor$Outbound, DutiesPayor>;
...
/** @internal */
export declare const CustomsDeclarationCreateRequest$outboundSchema: z.ZodMiniType<CustomsDeclarationCreateRequest$Outbound, CustomsDeclarationCreateRequest>;
