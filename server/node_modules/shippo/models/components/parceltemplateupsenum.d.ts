 ...
 */
export declare const ParcelTemplateUPSEnum: {
    ...
    readonly UpsMiBpm: "UPS_MI_BPM";
    readonly UPSMIBPMFlat: "UPS_MI_BPM_Flat";
    readonly UPSMIBPMParcel: "UPS_MI_BPM_Parcel";
    readonly UPSMIFirstClass: "UPS_MI_First_Class";
    readonly UPSMIFlat: "UPS_MI_Flat";
    readonly UPSMIIrregular: "UPS_MI_Irregular";
    readonly UPSMIMachinable: "UPS_MI_Machinable";
    readonly UpsMiMediaMail: "UPS_MI_MEDIA_MAIL";
    readonly UPSMIParcelPost: "UPS_MI_Parcel_Post";
    readonly UPSMIPriority: "UPS_MI_Priority";
    readonly UPSMIStandardFlat: "UPS_MI_Standard_Flat";
...
/** @internal */
export declare const ParcelTemplateUPSEnum$inboundSchema: z.ZodMiniEnum<typeof ParcelTemplateUPSEnum>;
/** @internal */
export declare const ParcelTemplateUPSEnum$outboundSchema: z.ZodMiniEnum<typeof ParcelTemplateUPSEnum>;
//# sourceMappingURL=parceltemplateupsenum.d.ts.map