...
/** @internal */
export declare const ServiceGroupUpdateRequest$outboundSchema: z.ZodMiniType<ServiceGroupUpdateRequest$Outbound, ServiceGroupUpdateRequest>;
export declare function serviceGroupUpdateRequestToJSON(serviceGroupUpdateRequest: ServiceGroupUpdateRequest): string;
