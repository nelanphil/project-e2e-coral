 ...
 */
export declare const ParcelTemplateFedExEnum: {
 ...
 * | FedEx_XL_Pak | FedEx® Extra Large Pak | 17.50 x 20.75 x 2.00 in|
 */
export type ParcelTemplateFedExEnum = ClosedEnum<typeof ParcelTemplateFedExEnum>;
/** @internal */
export declare const ParcelTemplateFedExEnum$inboundSchema: z.ZodMiniEnum<typeof ParcelTemplateFedExEnum>;
/** @internal */
export declare const ParcelTemplateFedExEnum$outboundSchema: z.ZodMiniEnum<typeof ParcelTemplateFedExEnum>;
//# sourceMappingURL=parceltemplatefedexenum.d.ts.map