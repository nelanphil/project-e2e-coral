...
/** @internal */
export declare const InvoiceNumber$inboundSchema: z.ZodMiniType<InvoiceNumber, unknown>;
/** @internal */
...
/** @internal */
export declare const InvoiceNumber$outboundSchema: z.ZodMiniType<InvoiceNumber$Outbound, InvoiceNumber>;
export declare function invoiceNumberToJSON(invoiceNumber: InvoiceNumber): string;
export declare function invoiceNumberFromJSON(jsonString: string): SafeParseResult<InvoiceNumber, SDKValidationError>;
