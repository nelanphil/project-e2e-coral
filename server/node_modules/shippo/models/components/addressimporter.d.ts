...
/** @internal */
export declare const AddressImporter$outboundSchema: z.ZodMiniType<AddressImporter$Outbound, AddressImporter>;
export declare function addressImporterToJSON(addressImporter: AddressImporter): string;
