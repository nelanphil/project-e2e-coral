...
/** @internal */
export declare const Insurance$inboundSchema: z.ZodMiniType<Insurance, unknown>;
/** @internal */
...
/** @internal */
export declare const Insurance$outboundSchema: z.ZodMiniType<Insurance$Outbound, Insurance>;
