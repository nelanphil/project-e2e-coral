 ...
 */
function ratesListShipmentRatesByCurrencyCode(client, request, options) {
    return new async_js_1.APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(operations.ListShipmentRatesByCurrencyCodeRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
