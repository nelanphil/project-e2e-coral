 ...
 */
export declare function shipmentsList(client: ShippoCore, request: operations.ListShipmentsRequest, options?: RequestOptions): APIPromise<Result<components.ShipmentPaginatedList, ShippoError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
