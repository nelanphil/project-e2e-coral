 ...
 */
export declare function userParcelTemplatesCreate(client: ShippoCore, request: components.UserParcelTemplateCreateRequest, options?: RequestOptions): APIPromise<Result<components.UserParcelTemplate, ShippoError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
//# sourceMappingURL=userParcelTemplatesCreate.d.ts.map