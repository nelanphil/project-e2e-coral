 ...
 */
export declare function ratesListShipmentRatesByCurrencyCode(client: ShippoCore, request: operations.ListShipmentRatesByCurrencyCodeRequest, options?: RequestOptions): APIPromise<Result<components.RatePaginatedList, ShippoError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
