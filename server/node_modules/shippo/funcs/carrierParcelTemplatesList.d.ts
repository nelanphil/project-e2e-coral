 ...
 * </ul>
 */
export declare function carrierParcelTemplatesList(client: ShippoCore, include?: operations.Include | undefined, carrier?: string | undefined, options?: RequestOptions): APIPromise<Result<components.CarrierParcelTemplateList, ShippoError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
