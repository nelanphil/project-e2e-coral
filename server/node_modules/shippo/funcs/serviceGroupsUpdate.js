...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(z.optional(components.ServiceGroupUpdateRequest$outboundSchema), value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result] = await M.match(M.json(200, components.ServiceGroup$inboundSchema), M.fail([400, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
