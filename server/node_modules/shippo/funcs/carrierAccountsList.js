...
async function $do(client, request, options) {
    const parsed = (0, schemas_js_1.safeParse)(request, (value) => z.parse(operations.ListCarrierAccountsRequest$outboundSchema, value), "Input validation failed");
    if (!parsed.ok) {
    ...
    const [result] = await M.match(M.json(200, components.CarrierAccountPaginatedList$inboundSchema), M.fail([400, "4XX"]), M.fail("5XX"))(response, req);
    if (!result.ok) {
